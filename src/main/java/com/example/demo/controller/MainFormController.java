...
public class MainFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (StoreUserService.currentUser != null && StoreUserService.currentUser.getRoles().contains(StoreUserService.ROLES.CUSTOMER.toString())) {
            hbEditProduct.setVisible(false); // Скрываем кнопку редактирования продукта для пользователей
        }
    }
}
